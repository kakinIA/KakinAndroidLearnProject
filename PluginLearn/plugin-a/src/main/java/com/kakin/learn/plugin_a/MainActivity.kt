...
class MainActivity : BasePluginActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById(R.id.btn_goto_other_activity).setOnClickListener {
            gotoOtherActivity()
        }

        findViewById(R.id.btn_test_class).setOnClickListener {
            PluginAClass().run {
        ...
        findViewById(R.id.btn_register_receiver).setOnClickListener {
